...
void One::Init(){
  ...
  ligth= new CubeLigth(); 
  ligth->addShader("./shader/cubeLigth/vs.frag", "./shader/cubeLigth/fr.frag");
  ligth->addBuffer(verticesl, sizeof(verticesl),0, 0);
  //ligth->addTexture("./1298130.jpg") ;
  ligth->Init(camera);
  ligth->addUniformShader(camera->projection, camera->view);
